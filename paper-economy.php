                                            ...
                                            <div class="modal-body">
                                                <div class="rating-review-star">
                                                    ...
                                                    <div class="stars">
                                                        ...
                                                        <input class="stars__checkbox" type="radio" id="second-star"
                                                            name="star">
                                                        ...
                                                        <input class="stars__checkbox" type="radio" id="third-star"
                                                            name="star">
                                                        ...
                                                        <input class="stars__checkbox" type="radio" id="fourth-star"
                                                            name="star">
                                                        ...
                                                        <input class="stars__checkbox" type="radio" id="fifth-star"
                                                            name="star">
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Write a
                                                        review here...
                                                    </label>
                                                                ...
                                                                <div class="client-review-box ">
                                                                    <div class="reviw-star">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="20.563" height="19.602"
                                                                            viewBox="0 0 20.563 19.602">
                                                                            <path id="Path_4456" data-name="Path 4456"
                                                                                d="M130.574,245.639l6.042.891a.611.611,0,0,1,.34,1.037l-4.373,4.26a.608.608,0,0,0-.178.535l1.02,6.026a.617.617,0,0,1-.891.648l-5.394-2.851a.588.588,0,0,0-.567,0l-5.41,2.835a.613.613,0,0,1-.891-.648l1.037-6.009a.594.594,0,0,0-.178-.535l-4.373-4.26a.608.608,0,0,1,.34-1.037l6.042-.875a.579.579,0,0,0,.454-.34l2.705-5.475a.616.616,0,0,1,1.1,0l2.689,5.475A.715.715,0,0,0,130.574,245.639Z"
                                                                                transform="translate(-116.575 -239.5)"
                                                                                fill="#f4c914"></path>
                                                                        </svg>
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="20.563" height="19.602"
                                                                    ...
                                                                    <div class="client main_heading">
                                                                        <h2>Print Is Good <span>, Great Service</span>
                                                                        </h2>
                                                                    </div>
                                                                    <div class="client-info-reviw main_heading">
                                                                        <p>nteger quis auctor elit sed vulputate.
                                                                            Rhoncus aenean vel elit
                                                                            scelerisque mauris. Elementum curabitur
                                                                            vitae nunc sed velit dignissim
                                                                            sodales ut eu. Donec pretium vulputate
                                                                            sapien nec sagittis aliquam
                                                                            malesuada bibendum arcu. Ornare arcu odio ut
