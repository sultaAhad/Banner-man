                ...
                <div class="register-wrapper">
                    ...
                    <div class="sign-member-form">
                        <form class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="info-btn">
                                    <a href="profile.php" class="btn btn-primary ">Register <svg xmlns="http://www.w3.org/2000/svg" width="9.115" height="7.588" viewBox="0 0 9.115 7.588">
                    ...
                    <div class="terms">
                        <span>By Creating Account you are agree to our <a href="terms-condition.php"> Terms & conditions</a></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
