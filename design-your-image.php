                ...
                <div class="nav-tabs-design">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item nav-second" role="presentation">
                            <button class="nav-link second-links active" id="pills-hidden-tab" data-bs-toggle="pill"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link second-links " id="pills-home-tab" data-bs-toggle="pill"
                        ...
                        <li class="nav-item " role="presentation">
                            <button class="nav-link second-links1" id="pills-background-tab" data-bs-toggle="pill"
                        ...
                        <li class="nav-item " role="presentation">
                            <button class="nav-link second-links12 " id="pills-final-tab" data-bs-toggle="pill"
                                ...
                                <div class="flag-img">
                                    ...
                                    <div class="nex-prev-btn">
                                        <button class="prevtab btn btn-success">Prev <span><i
                                                    class="fa-solid fa-arrow-right"></i></span></button>
                                        <button class="nexttab btn btn-success">Next <span><i
                                                    class="fa-solid fa-arrow-right"></i></span></button>
                                    </div>
                                </div>
                            </div>
